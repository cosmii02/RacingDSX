...
namespace ForzaDSX
{
    partial class UI
    {
        ...
        "0");
			...
			this.throttleMaxResistanceTrackBar.Maximum = 255;
			...
			this.throttleMaxResistanceTrackBar.TickFrequency = 5;
			...
			this.throttleMinResistanceTrackBar.Maximum = 255;
			...
			this.throttleMinResistanceTrackBar.TickFrequency = 5;
